...
if __name__ == '__main__':
    ...
    parser.add_argument("arg1", type=str, default=None, help="can be set to client or server to initialise that functionality")
    parser.add_argument("--host", type=str, default="0.0.0.0", help="the host ip that the server will run on")
    parser.add_argument("--port", type=int, default=8000, help="the port that the server will run on")
